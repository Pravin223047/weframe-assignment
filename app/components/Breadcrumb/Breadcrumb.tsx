...
const Breadcrumb = () => {
  return (
    <div className="flex flex-col w-full md:flex-row gap-4 items-center justify-between py-4 md:px-6">
      ...
      <div className="flex flex-col sm:flex-row md:flex-col w-full md:w-auto items-center space-x-2 justify-between md:justify-center text-center gap-2">
        ...
        <button className="border-2 border-teal-500 w-full md:w-[300px] text-teal-500 rounded-[20px] rounded-bl-none rounded-tr-none px-4 py-1 text-sm hover:bg-teal-100 transition-all duration-300 ease-in-out transform hover:scale-105">
          Preisoptionen
        </button>
      </div>
    </div>
