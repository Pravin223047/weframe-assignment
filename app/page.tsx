      ...
      <div className="container mx-auto px-4 flex flex-col md:flex-row gap-4">
        ...
        <div className="w-full md:w-3/4 lg:w-4/5">
          ...
          <div className="w-full flex items-center justify-end gap-2 mt-4 mb-4">
            <button aria-label="Previous Page" className="text-[#116A6C]">
              ←
            </button>
            <button aria-label="Page 1" className="text-[#116A6C] text-bold">
              1
            </button>
            <button aria-label="Page 2" className="text-[#116A6C] text-bold">
              2
            </button>
            <button aria-label="Page 3" className="text-[#116A6C] text-bold">
              3
            </button>
            <p aria-label="More Pages">• • •</p>
            <button aria-label="Page 12" className="text-[#116A6C] text-bold">
              12
            </button>
            <button aria-label="Next Page" className="text-[#116A6C]">
              →
            </button>
          </div>
        </div>
